        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-5xl leading-tight font-bold mb-6">
              ...
              <br />
              <span className="text-cyan-400">y empieza a sortear.</span>
            </h2>
            <p className="text-slate-300 text-lg leading-relaxed mb-12">
              Únete a la plataforma líder para gestionar tus sorteos, concursos
              y dinámicas en vivo con total transparencia y facilidad.
            </p>
            <div className="space-y-5">
              <FeatureItem
                icon={<Users size={20} />}
                title="Gestión de participantes"
                description="Agrega tus listas de forma directa, ágil y sin límites."
              />
              <FeatureItem
                icon={<Trophy size={20} />}
                title="Historial protegido"
                description="Tus premios y ganadores quedan guardados de forma segura."
              />
              <FeatureItem
                icon={<ShieldCheck size={20} />}
                title="Seguridad avanzada"
                description="Garantizamos la privacidad y protección de todos tus accesos."
              />
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 animate__animated animate__fadeIn animate__faster">
        <div className="w-full max-w-lg">
          ...
          <form
            ...
            className="bg-white rounded-3xl border border-slate-100 shadow-[0_10px_40px_rgba(0,0,0,0.08)] p-8"
          >
            <div className="mb-8">
              ...
              <p className="text-slate-500">
                Regístrate para comenzar a configurar tus eventos.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-600">
                Al registrarte, tendrás acceso inmediato a las herramientas de
                personalización y control de eventos.
              </div>
  ...
  return (
    <div>
      ...
      <div className="relative group">
        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-cyan-500">
          {icon}
        </div>
        <input
          type={type}
          ...
          value={value}
          onChange={onChange}
          className="w-full pl-12 pr-4 py-3 rounded-2xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-cyan-400"
        />
      </div>
    </div>
  );
