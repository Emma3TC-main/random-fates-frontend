  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-[#f5f7fb]">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-[#071426] text-white animate__animated animate__fadeIn animate__faster">
        ...
        <div className="absolute top-1/2 right-10 w-6 h-6 bg-cyan-400 rounded-full opacity-70 animate-pulse" />

        <div className="absolute top-24 left-24 w-4 h-4 bg-emerald-300 rounded-full opacity-80 animate-pulse" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="max-w-xl">
            {/* Badge */}
            <div className="animate__animated animate__fadeInUp animate__fast inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-400/20 bg-white/5 backdrop-blur-sm mb-8">
            ...
            {/* Hero */}
            <h2 className="animate__animated animate__fadeInUp animate__fast text-5xl leading-tight font-bold mb-6">
              El azar,
              <br />
              <span className="text-cyan-400">a tu favor.</span>
            </h2>

            <p className="animate__animated animate__fadeInUp animate__fast text-slate-300 text-lg leading-relaxed mb-12">
              Accede a tu cuenta y continúa creando experiencias memorables para
              tu comunidad.
            </p>

            {/* Features */}
            <div className="space-y-5 animate__animated animate__fadeInUp animate__fast">
              <FeatureItem
          ...
          {/* Círculos inferiores */}
          <div className="animate__animated animate__fadeInUp animate__fast flex items-center gap-[-10px]">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 animate__animated animate__fadeIn animate__fast">
        <div className="w-full max-w-md">
          ...
          {/* Card */}
          <div className="animate__animated animate__fadeInUp animate__fast bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-slate-100 p-8 transition duration-500 hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)]">
            {/* Header */}
            <div className="mb-8 animate__animated animate__fadeInUp animate__fast">
            ...
            <div className="space-y-5 animate__animated animate__fadeInUp animate__fast">
              ...
              <button
                onClick={handleLogin}
                className="w-full py-3 rounded-2xl bg-[#071426] hover:bg-[#0d1f38] text-white font-semibold transition-all duration-300 shadow-lg shadow-cyan-500/10 hover:scale-[1.02] hover:shadow-cyan-500/20"
              >
                Ingresar
              </button>
