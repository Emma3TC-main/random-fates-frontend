  ...
  return (
    <footer className="relative mt-20 overflow-hidden border-t border-[#42DEE1]/20 bg-gradient-to-r from-[#3FC5F0] via-[#42DEE1] to-[#3FC5F0] text-white">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-10 top-0 h-40 w-40 rounded-full bg-[#EEF5B2]/20 blur-3xl" />

        <div className="absolute bottom-0 right-0 h-40 w-40 rounded-full bg-[#6DECB9]/20 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-3xl border border-white/20 bg-white/10 shadow-xl backdrop-blur">
                <img
                  src={logo}
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-sm md:flex-row">
          ...
          <div className="flex items-center gap-5 text-white/70">
            <button className="transition hover:text-white">Privacidad</button>

            <button className="transition hover:text-white">Términos</button>
